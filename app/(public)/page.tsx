  ...
  : [
      {
        ...
        body: "Explore our full range of raw honeys, beeswax products, and seasonal varieties — each one harvested by hand from our Nottinghamshire hives.",
      },
      {
        icon: ShieldCheck,
        title: "Order securely",
        body: "Checkout in seconds with our secure Stripe-powered payment. Choose home delivery or collect from the apiary.",
      },
      {
        icon: PackageCheck,
        title: "Delivered to your door",
        body: "We pack every order ourselves and ship with next-day delivery across the UK. Your honey arrives exactly as it left our hands.",
      },
    ];
  ...
  return (
    <>
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
        <Image
          src="https://images.unsplash.com/photo-1558642452-9d2a7deb7f62?w=1600&q=85"
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 text-center text-white">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-sm font-medium backdrop-blur-sm">
            <FlameKindling className="h-3.5 w-3.5 text-harvest-400" />
            {config.brand.location} · Raw &amp; Unfiltered · Est.{" "}
          ...
          <p className="mx-auto mb-10 max-w-2xl text-lg leading-relaxed text-white/85 sm:text-xl">
            {config.brand.tagline}. Cold-extracted, never heated, bottled
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            ...
            >
              Shop our honey <ArrowRight className="h-4 w-4" />
            </Link>
            <Link
      ...
      {/* ── OUR STORY (single-store) / MEET PRODUCERS (marketplace) */}
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid items-center gap-12 lg:grid-cols-2">
              ...
              <div className="relative h-80 overflow-hidden rounded-3xl lg:h-[480px]">
                <Image
                  src="https://images.unsplash.com/photo-1566843972142-a7fcf70a4b83?w=800&q=80"
      ...
      <section className="relative overflow-hidden bg-forest-800 py-24">
        <div className="absolute inset-0 opacity-10">
          <Image
            src="https://images.unsplash.com/photo-1471943311424-646960669fbc?w=1600&q=60"
            alt=""
            fill
        ...
        <div className="relative mx-auto max-w-3xl px-4 text-center">
          ...
          >
            Shop our honey <ArrowRight className="h-5 w-5" />
          </Link>
        </div>
      </section>
    </>
